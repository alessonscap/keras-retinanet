...
def parse_args(args):
    ...
    parser.add_argument('--nms-threshold',help='Non maximum suppression threshold',type=float, default=0.5)
    parser.add_argument('--no-class-specific-filter', help='Disables class specific filtering.', dest='class_specific_filter', action='store_false')
    parser.add_argument('--anchors_boxes', help='Define the archos ratios.',type='str',default='0.5,1,2')
...
def main(args=None):
    ...
    model = models.load_model(args.model_in, convert=True, backbone_name=args.backbone, nms=args.nms, class_specific_filter=args.class_specific_filter,nms_threshold=args.nms_threshold,anchors_ratios=args.anchor_anchor_boxes)
