...
def ResNet(inputs, blocks, block, include_top=True, classes=1000, freeze_bn=True, numerical_names=None,noise_aug_std=None, *args, **kwargs):
    """
    ...
    if noise_aug_std is not None:
        x = GaussianNoiseOur(stddev=noise_aug_std,scale=10, name="gaussianNoise")(inputs)
        x = keras.layers.ZeroPadding2D(padding=3, name="padding_conv1")(x)
    else:
...
def ResNet50(inputs, blocks=None, include_top=True, classes=1000,noise_aug_std=None, *args, **kwargs):
    """
    ...
    return ResNet(inputs, blocks, numerical_names=numerical_names, block=keras_resnet.blocks.bottleneck_2d, include_top=include_top, classes=classes,noise_aug_std=noise_aug_std, *args, **kwargs)

def ResNet101(inputs, blocks=None, include_top=True, classes=1000,noise_aug_std=None, *args, **kwargs):
    """
